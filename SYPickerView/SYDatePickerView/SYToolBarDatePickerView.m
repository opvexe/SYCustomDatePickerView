...
@interface SYToolBarDatePickerView ()
@property (nonatomic, strong) SYCustomDatePickerView *datePickerView;
...
@implementation SYToolBarDatePickerView
...
-(SYCustomDatePickerView *)datePickerView {
    if (_datePickerView == nil) {
        _datePickerView = [[SYCustomDatePickerView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.separatorLine.frame), self.frame.size.width, self.contentView.frame.size.height - CGRectGetMaxY(self.separatorLine.frame))];
        WEAKSELF(weakSelf);
