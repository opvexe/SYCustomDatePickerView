...
@interface SYCustomDatePickerView ()<UIPickerViewDelegate, UIPickerViewDataSource>
{
...
@property (nonatomic, strong) SYCustomDateModel *maxDateModel;
@property (nonatomic, strong) SYCustomDateModel *minDateModel;
@property (nonatomic, strong) SYCustomDateModel *defaultDateModel;
...
@end
@implementation SYCustomDatePickerView
...
-(void)defaultSelectInComponent {
    ...
    switch (self.datePickerType) {
        ...
        case SYCustomDatePickerViewTypeYearMonthDay: {
            ...
            break;
        case SYCustomDatePickerViewTypeYearMonth: {
            [self.pickerView selectRow:selectedYearIndex   inComponent:0 animated:NO];
            [self.pickerView selectRow:selectedMonthIndex  inComponent:1 animated:NO];
        }
            break;
        case SYCustomDatePickerViewTypeYearMonthDayHourMinute: {
            [self.pickerView selectRow:selectedYearIndex   inComponent:0 animated:NO];
            [self.pickerView selectRow:selectedMonthIndex  inComponent:1 animated:NO];
            [self.pickerView selectRow:selectedDayIndex    inComponent:2 animated:NO];
            ...
            break;
        case SYCustomDatePickerViewTypeHourMinute: {
...
-(void)setMinDate:(NSDate *)minDate {
    ...
    SYCustomDateModel *minDateModel = [SYCustomDateModel modelWithDate:minDate isMaxDate:NO];
...
-(void)setMaxDate:(NSDate *)maxDate {
    ...
    SYCustomDateModel *maxDateModel = [SYCustomDateModel modelWithDate:maxDate isMaxDate:YES];
...
-(void)setDefaultDate:(NSDate *)defaultDate {
    ...
    self.defaultDateModel = [SYCustomDateModel modelWithDate:self.defaultDate isMaxDate:NO];
...
-(void)setDatePickerType:(SYCustomDatePickerViewType)datePickerType {
